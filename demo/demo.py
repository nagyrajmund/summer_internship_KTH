...
def parse_args():
    ...
    parser.add_argument('audio', type=str, help="path to the input speech recording")
    ...
    parser.add_argument('--video_out', '-video', type=str, default="generated_motion.mp4",
                        help="the path where the generated video will be saved.")
    parser.add_argument('--model_file', '-model', type=str, default="fasttext_prosody.ckpt",
